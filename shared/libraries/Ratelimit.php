...
class Ratelimit {
    ...
    public function check($bucket, $burst = NULL, $window = 1) {
        ...
        // RATE_LIMIT_SCALE melonggarkan batas untuk uji otomatis lokal (banyak akun
        // dari satu IP). Sengaja DIABAIKAN di produksi.
        if (ENVIRONMENT !== 'production') {
            $burst *= max(1, (int) env('RATE_LIMIT_SCALE', 1));
        }
